/**
 * pdfGenerator.js
 * Generates a branded Panchayat Application Form PDF using jsPDF + jspdf-autotable
 */
...
export const generateApplicationPDF = async (scheme, user) => {
  ...
  // Kerala Panchayat Emblem placeholder (text-based)
  doc.setFillColor(255, 255, 255, 0.15);
  doc.circle(margin + 10, 19, 10, 'S'); // emblem circle outline
  ...
  const applicantRows = [
    ...
    ['Annual Household Income', user?.annualIncome ? `₹ ${user.annualIncome.toLocaleString('en-IN')}` : '₹ __________'],
